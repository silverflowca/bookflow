-- ============================================================================
-- BookFlow - Collaboration Migration (003)
...
-- Comments (inline + chapter-level, threaded)
...
-- Auto-update updated_at on book_comments
...
-- Auto-increment version_number per book
...
-- Helper: is user a collaborator or owner of a book?
...
-- Update books SELECT policy to allow collaborators to see private books
